...
import com.example.notesapp.notes.NotesPresenter;
import com.example.notesapp.util.EspressoIdlingResource;
import com.example.notesapp.util.ImageFileImpl;
...
public class AddNoteFragment extends Fragment implements AddNoteContract.View {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
       ...
       mActionListener = new AddNotePresenter(NoteRepositories.getInMemoryRepoInstance(new NotesServiceApiImpl()), this,
               new ImageFileImpl());
