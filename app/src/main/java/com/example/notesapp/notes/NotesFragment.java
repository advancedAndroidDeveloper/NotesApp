...
import com.example.notesapp.notedetail.NoteDetailActivity;
...
public class NotesFragment extends Fragment implements NotesContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       mActionsListener = new NotesPresenter(NoteRepositories.getInMemoryRepoInstance(new NotesServiceApiImpl()),this);
    }
